...
while True:       
    ...
    cv.putText(frame, "LASER   - Distance-z: %.3f" % (distZ), (20,50),cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0)) 
    cv.putText(frame, "MARKER  - Distance-z: %.3f" % (markPos[2]), (20,80), cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0))
    cv.putText(frame, "FEATURE - Speed-x: %.3f - y: %.3f" % (speed[0],speed[1]), (20,110),cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0))   
    cv.putText(frame, "MARKER  - Speed-x: %.3f - y: %.3f" % (markSpeed[0],markSpeed[1]), (20,140),cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0))
    if activeSerialPort and ser.isOpen:
        cv.putText(frame, "Serial port: " + str(lastline), (20,170),cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0))
